...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            user = _a.sent();
                            return [2 /*return*/, this.generateToken(user.id, user.email, user.role)];
                    }
                });
            });
        };
        ...
        AuthService_1.prototype.generateToken = function (userId, email, role) {
            return __awaiter(this, void 0, void 0, function () {
                var payload, token;
                return __generator(this, function (_a) {
                    switch (_a.label) {
