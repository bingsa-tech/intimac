...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.getAdminData = function () {
    ...
    (function () {
        ...
        _getAdminData_decorators = [(0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), roles_guard_1.RolesGuard), (0, roles_decorator_1.Roles)(client_1.Role.ADMIN), (0, common_1.Get)('admin-only')];
        ...
        __esDecorate(_classThis, null, _getAdminData_decorators, { kind: "method", name: "getAdminData", static: false, private: false, access: { has: function (obj) { return "getAdminData" in obj; }, get: function (obj) { return obj.getAdminData; } }, metadata: _metadata }, null, _instanceExtraInitializers);
