...
var CreateProvinceDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function CreateProvinceDto() {
                this.name = __runInitializers(this, _name_initializers, void 0);
                this.countryId = (__runInitializers(this, _name_extraInitializers), __runInitializers(this, _countryId_initializers, void 0));
                __runInitializers(this, _countryId_extraInitializers);
            }
            return CreateProvinceDto;
        }()),
        (function () {
