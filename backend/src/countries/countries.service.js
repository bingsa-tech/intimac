...
var CountriesService = function () {
    ...
    var CountriesService = _classThis = /** @class */ (function () {
        function CountriesService_1(prisma) {
            this.prisma = prisma;
        }
        CountriesService_1.prototype.create = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                var existing;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.country.findFirst({
                                where: { name: { equals: dto.name, mode: 'insensitive' } },
                            })];
                        case 1:
                            existing = _a.sent();
                            if (existing) {
                                throw new common_1.ConflictException('Ce pays existe déjà');
                            }
                            return [2 /*return*/, this.prisma.country.create({ data: dto })];
                    }
                });
            });
        };
        CountriesService_1.prototype.findAll = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.country.findMany({
                            orderBy: { name: 'asc' },
                        })];
                });
            });
